                    ...
                    [...Array(4)].map((_, index) => (
                        <div key={index} className="col-sm-6 col-lg-3">
                            <div className="review-card p-3 h-100">
                                <div className="skeleton mb-3" style={{ aspectRatio: '2/3', width: '100%' }}></div>
                                ...
                                <div className="d-flex align-items-center gap-3 pt-2 border-top border-white border-opacity-10 justify-content-between">
                                    <div style={{ width: '40%' }}>
                                        <div className="skeleton mb-1" style={{ height: '12px', width: '50%' }}></div>
                                        <div className="skeleton" style={{ height: '14px', width: '100%' }}></div>
                                    </div>
                                    <div style={{ width: '40%' }}>
                                        <div className="skeleton mb-1" style={{ height: '12px', width: '50%', marginLeft: 'auto' }}></div>
                                        <div className="skeleton" style={{ height: '14px', width: '100%', marginLeft: 'auto' }}></div>
                                    </div>
                                </div>
                            </div>
                        </div>
